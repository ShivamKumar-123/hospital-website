...
export default function Testimonials() {
  ...
  return (
    <div className="space-y-5">
      ...
      <Modal open={openForm} onClose={() => setOpenForm(false)} title="Add testimonial" subtitle="Capture what patients love about Saubhagyam Hospital." icon={<Star size={20} />} intent="default">
